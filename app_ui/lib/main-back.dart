  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        //这是您的应用程序的主题。
        //
        //尝试使用“ flutter run”运行应用程序。 您会看到
        //应用程序有一个蓝色的工具栏。 然后，在不退出应用程序的情况下尝试
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          //
          //调用“调试绘画”（在控制台中按“ p”，选择
          //来自Android的Flutter Inspector的“切换调试画图”操作
          // Studio，或Visual Studio Code中的“切换调试画图”命令）
          //以查看每个小部件的线框。
          //
          //列具有各种属性来控制其自身的大小以及
          //它如何定位其子级。 这里我们使用mainAxisAlignment来
          //将孩子垂直居中； 主轴在这里是垂直
          //轴，因为列是垂直的（交叉轴为
          //水平）。
